...
import jp.co.sunselcospace.data.ConnectionManager;
...
public class BookingDao {
	 ...
	 * @throws NamingException
	 */
	public int countBookingsByRoomIdAndDate(Integer roomId, LocalDate bookingDate) throws SQLException, NamingException {
		// connectionの取得
		try (Connection connection = ConnectionManager.getConnection();
				PreparedStatement ps = connection.prepareStatement(
						"SELECT COUNT(*) AS cnt " +
